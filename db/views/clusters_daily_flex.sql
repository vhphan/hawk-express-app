drop materialized view if exists daily_stats.clusters_kpi_nrcellcu_flex;
create materialized view daily_stats.clusters_kpi_nrcellcu_flex as
with dt as (
...
drop materialized view if exists daily_stats.clusters_kpi_eutrancellfdd_flex;
create materialized view daily_stats.clusters_kpi_eutrancellfdd_flex as
with dt as (
...
refresh materialized view concurrently daily_stats.clusters_kpi_eutrancellfdd_flex;
refresh materialized view concurrently daily_stats.clusters_kpi_nrcellcu_flex;
refresh materialized view concurrently daily_stats.clusters_kpi_nrcelldu_flex;
