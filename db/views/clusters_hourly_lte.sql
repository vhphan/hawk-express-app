...
--erbs_eutrancellfdd
drop materialized view if exists dnb.hourly_stats.clusters_kpi_erbs_eutrancellfdd;
create materialized view dnb.hourly_stats.clusters_kpi_erbs_eutrancellfdd as
with dt as (
...
drop materialized view if exists dnb.hourly_stats.clusters_kpi_erbs_eutrancellrelation;
create materialized view dnb.hourly_stats.clusters_kpi_erbs_eutrancellrelation as
with dt as (
...
drop materialized view if exists dnb.hourly_stats.clusters_kpi_erbs_eutrancellfdd_v;
create materialized view dnb.hourly_stats.clusters_kpi_erbs_eutrancellfdd_v as
with dt as (
...
select date_id, "Cluster_ID" as cluster_id,
...
create unique index on hourly_stats.clusters_kpi_erbs_eutrancellfdd(date_id, cluster_id);
create unique index on hourly_stats.clusters_kpi_erbs_eutrancellrelation(date_id, cluster_id);
create unique index on hourly_stats.clusters_kpi_erbs_eutrancellfdd_v(date_id, cluster_id);
